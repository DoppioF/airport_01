...
//					System.out.println(cleanedInput.get(index) + " " + word);
	...
	public List<QueryFromSearcher> buildQuery(List<String> finalFlow, Map<String, String> keywords, Map<String, String> secondaryKeywords, List<DbTableStructure> tableList) throws SearcherException {
		List<QueryFromSearcher> queryList = new ArrayList<>();
		String[] queries = interpreter.buildQuery(finalFlow, foundKeywords, keywords, SECONDARY_KEYWORD_PREFIX, PRIMARY_KEYWORD_PREFIX, secondaryKeywords, tableList);
